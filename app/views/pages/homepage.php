...
<body>
  ...
  <div class="testimonial-container">
    ...
    <img src="<?php echo URLROOT ?>/public/images/p1.png" alt="company 1">
        ...
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <p class="testimonial-user">- SHOOT</p>
    </div>
    <div class="testimonial">
    <img src="<?php echo URLROOT ?>/public/images/p2.png" alt="company 2">
        ...
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <p class="testimonial-user">- STUDIO </p>
    </div>
    <div class="testimonial">
    <img src="<?php echo URLROOT ?>/public/images/p3.png" alt="company 3">
        ...
        <p class="testimonial-user">- IPHOTO</p>
    </div>
    <div class="testimonial">
    <img src="<?php echo URLROOT ?>/public/images/p4.png" alt="company 4">
        ...
        <span class="fa fa-star"></span>
        <span class="fa fa-star"></span>
        <p class="testimonial-user">- PHOTOO</p>
    </div>
...
<script src="script.js"></script>
    ...
    <div class="contact">
    <p>
    <img src="<?php echo URLROOT ?>/public/images/phone icon.jpg" alt="icon1" width="50px" height="50px">
      <h6>+9472638717<h6>
    <img src="<?php echo URLROOT ?>/public/images/whatsapp.png" alt="icon2" width="50px" height="50px">
      <h6>Whatsapp</h6>
    <img src="<?php echo URLROOT ?>/public/images/fb.jpg" alt="icon3" width="50px" height="50px">
      <h6>Facebook</h6></p>
</div>
